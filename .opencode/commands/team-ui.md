---
description: "Orchestrate the UI team through the full UX pipeline: from UX spec authoring through visual design, implementation, review, and polish. Integrates with /ux-design, /ux-review, a..."
agent: build
---

# /team-ui (OpenCode command - ported from CCGS skill `team-ui`)

> Original skill: `.claude/skills/team-ui/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/team-ui $ARGUMENTS`
> Original argument hint: `[UI feature description] [--review full|lean|solo]`
