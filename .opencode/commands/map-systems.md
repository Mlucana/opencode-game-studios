...
# /map-systems (OpenCode command - ported from CCGS skill `map-systems`)

> Original skill: `.claude/skills/map-systems/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/map-systems $ARGUMENTS`
> Original argument hint: `[next | system-name] [--review full|lean|solo]`
