---
description: "Guided, section-by-section UX spec authoring for a screen, flow, or HUD. Reads game concept, player journey, and relevant GDDs to provide context-aware design guidance. Produces..."
agent: build
---

# /ux-design (OpenCode command - ported from CCGS skill `ux-design`)

> Original skill: `.claude/skills/ux-design/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/ux-design $ARGUMENTS`
> Original argument hint: `[screen/flow name] or 'hud' or 'patterns'`
