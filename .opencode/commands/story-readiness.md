---
description: "Validate that a story file is implementation-ready. Checks for embedded GDD requirements, ADR references, engine notes, clear acceptance criteria, and no open design questions. ..."
agent: build
---

# /story-readiness (OpenCode command - ported from CCGS skill `story-readiness`)

> Original skill: `.claude/skills/story-readiness/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/story-readiness $ARGUMENTS`
> Original argument hint: `[story-file-path or 'all' or 'sprint']`
