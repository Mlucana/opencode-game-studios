...
# /retrospective (OpenCode command - ported from CCGS skill `retrospective`)

> Original skill: `.claude/skills/retrospective/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/retrospective $ARGUMENTS`
> Original argument hint: `[sprint-N|milestone-name]`
