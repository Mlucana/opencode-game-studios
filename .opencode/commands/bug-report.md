---
description: "Creates a structured bug report from a description, or analyzes code to identify potential bugs. Ensures every bug report has full reproduction steps, severity assessment, and c..."
agent: build
---

# /bug-report (OpenCode command - ported from CCGS skill `bug-report`)

> Original skill: `.claude/skills/bug-report/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/bug-report $ARGUMENTS`
> Original argument hint: `[description] | analyze [path-to-file]`
