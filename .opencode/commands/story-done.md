---
description: "End-of-story completion review. Reads the story file, verifies each acceptance criterion against the implementation, checks for GDD/ADR deviations, prompts code review, updates ..."
agent: build
---

# /story-done (OpenCode command - ported from CCGS skill `story-done`)

> Original skill: `.claude/skills/story-done/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/story-done $ARGUMENTS`
> Original argument hint: `[story-file-path] [--review full|lean|solo]`
