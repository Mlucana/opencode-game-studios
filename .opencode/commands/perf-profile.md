...
# /perf-profile (OpenCode command - ported from CCGS skill `perf-profile`)

> Original skill: `.claude/skills/perf-profile/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/perf-profile $ARGUMENTS`
> Original argument hint: `[system-name or 'full']`
