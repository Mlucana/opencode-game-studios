---
description: "Validates a UX spec, HUD design, or interaction pattern library for completeness, accessibility compliance, GDD alignment, and implementation readiness. Produces APPROVED / NEED..."
agent: build
---

# /ux-review (OpenCode command - ported from CCGS skill `ux-review`)

> Original skill: `.claude/skills/ux-review/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/ux-review $ARGUMENTS`
> Original argument hint: `[file-path or 'all' or 'hud' or 'patterns']`
