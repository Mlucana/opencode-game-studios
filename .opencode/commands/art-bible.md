---
description: "Guided, section-by-section Art Bible authoring. Creates the visual identity specification that gates all asset production. Run after /brainstorm is approved and before /map-syst..."
agent: build
---

# /art-bible (OpenCode command - ported from CCGS skill `art-bible`)

> Original skill: `.claude/skills/art-bible/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
