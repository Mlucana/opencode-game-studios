---
description: "Analyzes game balance data files, formulas, and configuration to identify outliers, broken progressions, degenerate strategies, and economy imbalances. Use after modifying any b..."
agent: build
---

# /balance-check (OpenCode command - ported from CCGS skill `balance-check`)

> Original skill: `.claude/skills/balance-check/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/balance-check $ARGUMENTS`
> Original argument hint: `[system-name|path-to-data-file]`
