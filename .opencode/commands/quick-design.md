---
description: "Lightweight design spec for small changes — tuning adjustments, minor mechanics, balance tweaks. Skips full GDD authoring when a system GDD already exists or the change is too s..."
agent: build
---

# /quick-design (OpenCode command - ported from CCGS skill `quick-design`)

> Original skill: `.claude/skills/quick-design/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/quick-design $ARGUMENTS`
> Original argument hint: `[brief description of the change]`
