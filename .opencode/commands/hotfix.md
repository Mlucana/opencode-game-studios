...
# /hotfix (OpenCode command - ported from CCGS skill `hotfix`)

> Original skill: `.claude/skills/hotfix/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/hotfix $ARGUMENTS`
> Original argument hint: `[bug-id or description]`
