...
# /estimate (OpenCode command - ported from CCGS skill `estimate`)

> Original skill: `.claude/skills/estimate/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/estimate $ARGUMENTS`
> Original argument hint: `[task-description]`
