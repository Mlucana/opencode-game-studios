...
# /team-polish (OpenCode command - ported from CCGS skill `team-polish`)

> Original skill: `.claude/skills/team-polish/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/team-polish $ARGUMENTS`
> Original argument hint: `[feature or area to polish] [--review full|lean|solo]`
