---
description: "Generate a QA test plan for a sprint or feature. Reads GDDs and story files, classifies stories by test type (Logic/Integration/Visual/UI), and produces a structured test plan c..."
agent: build
---

# /qa-plan (OpenCode command - ported from CCGS skill `qa-plan`)

> Original skill: `.claude/skills/qa-plan/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/qa-plan $ARGUMENTS`
> Original argument hint: `[sprint | feature: system-name | story: path]`
