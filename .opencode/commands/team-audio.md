...
# /team-audio (OpenCode command - ported from CCGS skill `team-audio`)

> Original skill: `.claude/skills/team-audio/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/team-audio $ARGUMENTS`
> Original argument hint: `[feature or area to design audio for] [--review full|lean|solo]`
