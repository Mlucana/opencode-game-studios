---
description: "Guided game concept ideation — from zero idea to a structured game concept document. Uses professional studio ideation techniques, player psychology frameworks, and structured c..."
agent: build
---

# /brainstorm (OpenCode command - ported from CCGS skill `brainstorm`)

> Original skill: `.claude/skills/brainstorm/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/brainstorm $ARGUMENTS`
> Original argument hint: `[genre or theme hint, or 'open'] [--review full|lean|solo]`
