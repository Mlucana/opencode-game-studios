...
# /team-release (OpenCode command - ported from CCGS skill `team-release`)

> Original skill: `.claude/skills/team-release/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/team-release $ARGUMENTS`
> Original argument hint: `[version number or 'next'] [--review full|lean|solo]`
