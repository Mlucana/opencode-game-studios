...
# /tech-debt (OpenCode command - ported from CCGS skill `tech-debt`)

> Original skill: `.claude/skills/tech-debt/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/tech-debt $ARGUMENTS`
> Original argument hint: `[scan|add|prioritize|report]`
