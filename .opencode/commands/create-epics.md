---
description: "Translate approved GDDs + architecture into epics — one epic per architectural module. Defines scope, governing ADRs, engine risk, and untraced requirements. Does NOT break into..."
agent: build
---

# /create-epics (OpenCode command - ported from CCGS skill `create-epics`)

> Original skill: `.claude/skills/create-epics/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/create-epics $ARGUMENTS`
> Original argument hint: `[system-name | layer: foundation|core|feature|presentation | all] [--review full|lean|solo]`
