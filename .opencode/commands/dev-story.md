---
description: "Read a story file and implement it. Loads the full context (story, GDD requirement, ADR guidelines, control manifest), routes to the right programmer agent for the system and en..."
agent: build
---

# /dev-story (OpenCode command - ported from CCGS skill `dev-story`)

> Original skill: `.claude/skills/dev-story/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/dev-story $ARGUMENTS`
> Original argument hint: `[story-path]`
