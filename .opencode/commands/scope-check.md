---
description: "Analyze a feature or sprint for scope creep by comparing current scope against the original plan. Flags additions, quantifies bloat, and recommends cuts. Use when user says 'any..."
agent: build
---

# /scope-check (OpenCode command - ported from CCGS skill `scope-check`)

> Original skill: `.claude/skills/scope-check/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/scope-check $ARGUMENTS`
> Original argument hint: `[feature-name or sprint-N]`
