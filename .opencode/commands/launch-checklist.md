...
# /launch-checklist (OpenCode command - ported from CCGS skill `launch-checklist`)

> Original skill: `.claude/skills/launch-checklist/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/launch-checklist $ARGUMENTS`
> Original argument hint: `[launch-date or 'dry-run']`
