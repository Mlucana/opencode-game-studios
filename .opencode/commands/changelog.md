...
# /changelog (OpenCode command - ported from CCGS skill `changelog`)

> Original skill: `.claude/skills/changelog/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/changelog $ARGUMENTS`
> Original argument hint: `[version|sprint-number]`
