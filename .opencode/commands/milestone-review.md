---
description: "Generates a comprehensive milestone progress review including feature completeness, quality metrics, risk assessment, and go/no-go recommendation. Use at milestone checkpoints o..."
agent: build
---

# /milestone-review (OpenCode command - ported from CCGS skill `milestone-review`)

> Original skill: `.claude/skills/milestone-review/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/milestone-review $ARGUMENTS`
> Original argument hint: `[milestone-name|current] [--review full|lean|solo]`
