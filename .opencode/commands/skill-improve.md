...
# /skill-improve (OpenCode command - ported from CCGS skill `skill-improve`)

> Original skill: `.claude/skills/skill-improve/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/skill-improve $ARGUMENTS`
> Original argument hint: `[skill-name]`
