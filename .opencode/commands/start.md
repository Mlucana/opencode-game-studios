...
# /start (OpenCode command - ported from CCGS skill `start`)

> Original skill: `.claude/skills/start/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/start $ARGUMENTS`
> Original argument hint: `[no arguments]`
