---
description: "Pre-Production validation — build a production-quality end-to-end build to confirm the full game loop is achievable before committing to Production. Run after GDDs, architecture..."
agent: build
---

# /vertical-slice (OpenCode command - ported from CCGS skill `vertical-slice`)

> Original skill: `.claude/skills/vertical-slice/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/vertical-slice $ARGUMENTS`
> Original argument hint: `[--review full|lean|solo]`
