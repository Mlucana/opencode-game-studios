---
description: "Orchestrate the combat team: coordinates game-designer, gameplay-programmer, ai-programmer, technical-artist, sound-designer, and qa-tester to design, implement, and validate a ..."
agent: build
---

# /team-combat (OpenCode command - ported from CCGS skill `team-combat`)

> Original skill: `.claude/skills/team-combat/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/team-combat $ARGUMENTS`
> Original argument hint: `[combat feature description] [--review full|lean|solo]`
