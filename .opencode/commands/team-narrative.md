---
description: "Orchestrate the narrative team: coordinates narrative-director, writer, world-builder, and level-designer to create cohesive story content, world lore, and narrative-driven leve..."
agent: build
---

# /team-narrative (OpenCode command - ported from CCGS skill `team-narrative`)

> Original skill: `.claude/skills/team-narrative/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/team-narrative $ARGUMENTS`
> Original argument hint: `[narrative content description] [--review full|lean|solo]`
