---
description: "Performs an architectural and quality code review on a specified file or set of files. Checks for coding standard compliance, architectural pattern adherence, SOLID principles, ..."
agent: build
---

# /code-review (OpenCode command - ported from CCGS skill `code-review`)

> Original skill: `.claude/skills/code-review/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/code-review $ARGUMENTS`
> Original argument hint: `[path-to-file-or-directory]`
