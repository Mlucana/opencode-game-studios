---
description: "Brownfield onboarding — audits existing project artifacts for template format compliance (not just existence), classifies gaps by impact, and produces a numbered migration plan...."
agent: build
---

# /adopt (OpenCode command - ported from CCGS skill `adopt`)

> Original skill: `.claude/skills/adopt/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/adopt $ARGUMENTS`
> Original argument hint: `[focus: full | gdds | adrs | stories | infra]`
