...
# /help (OpenCode command - ported from CCGS skill `help`)

> Original skill: `.claude/skills/help/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/help $ARGUMENTS`
> Original argument hint: `[optional: what you just finished, e.g. 'finished design-review' or 'stuck on ADRs']`
