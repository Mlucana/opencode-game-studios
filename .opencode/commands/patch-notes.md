...
# /patch-notes (OpenCode command - ported from CCGS skill `patch-notes`)

> Original skill: `.claude/skills/patch-notes/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/patch-notes $ARGUMENTS`
> Original argument hint: `[version] [--style brief|detailed|full]`
