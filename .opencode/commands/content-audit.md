...
# /content-audit (OpenCode command - ported from CCGS skill `content-audit`)

> Original skill: `.claude/skills/content-audit/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/content-audit $ARGUMENTS`
> Original argument hint: `[system-name | --summary | (no arg = full audit)]`
