...
# /playtest-report (OpenCode command - ported from CCGS skill `playtest-report`)

> Original skill: `.claude/skills/playtest-report/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/playtest-report $ARGUMENTS`
> Original argument hint: `[new|analyze path-to-notes] [--review full|lean|solo]`
