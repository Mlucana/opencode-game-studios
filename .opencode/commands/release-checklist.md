...
# /release-checklist (OpenCode command - ported from CCGS skill `release-checklist`)

> Original skill: `.claude/skills/release-checklist/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/release-checklist $ARGUMENTS`
> Original argument hint: `[platform: pc|console|mobile|all]`
