---
description: "Read all open bugs in production/qa/bugs/, re-evaluate priority vs. severity, assign to sprints, surface systemic trends, and produce a triage report. Run at sprint start or whe..."
agent: build
---

# /bug-triage (OpenCode command - ported from CCGS skill `bug-triage`)

> Original skill: `.claude/skills/bug-triage/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/bug-triage $ARGUMENTS`
> Original argument hint: `[sprint | full | trend]`
