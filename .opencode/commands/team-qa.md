---
description: "Orchestrate the QA team through a full testing cycle. Coordinates qa-lead (strategy + test plan) and qa-tester (test case writing + bug reporting) to produce a complete QA packa..."
agent: build
---

# /team-qa (OpenCode command - ported from CCGS skill `team-qa`)

> Original skill: `.claude/skills/team-qa/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/team-qa $ARGUMENTS`
> Original argument hint: `[sprint | feature: system-name] [--review full|lean|solo]`
