---
description: "Reviews a game design document for completeness, internal consistency, implementability, and adherence to project design standards. Run this before handing a design document to ..."
agent: build
---

# /design-review (OpenCode command - ported from CCGS skill `design-review`)

> Original skill: `.claude/skills/design-review/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/design-review $ARGUMENTS`
> Original argument hint: `[path-to-design-doc] [--depth full|lean|solo]`
