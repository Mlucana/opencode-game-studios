---
description: "Generates a contextual onboarding document for a new contributor or agent joining the project. Summarizes project state, architecture, conventions, and current priorities releva..."
agent: build
---

# /onboard (OpenCode command - ported from CCGS skill `onboard`)

> Original skill: `.claude/skills/onboard/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/onboard $ARGUMENTS`
> Original argument hint: `[role|area]`
