---
description: "Orchestrate the live-ops team for post-launch content planning: coordinates live-ops-designer, economy-designer, analytics-engineer, community-manager, writer, and narrative-dir..."
agent: build
---

# /team-live-ops (OpenCode command - ported from CCGS skill `team-live-ops`)

> Original skill: `.claude/skills/team-live-ops/SKILL.md` — OpenCode also auto-discovers it via the `skill` tool.
> Usage: `/team-live-ops $ARGUMENTS`
> Original argument hint: `[season name or event description] [--review full|lean|solo]`
