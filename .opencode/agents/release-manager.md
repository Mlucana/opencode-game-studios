...
permission:
  ...
  websearch: deny
---
> Ported from `.claude/agents/release-manager.md` (Claude Code Game Studios) for OpenCode.
...
> Original skill hints `[release-checklist, changelog, patch-notes]` — load via the `skill` tool when relevant.
