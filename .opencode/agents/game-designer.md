...
permission:
  bash: deny
---
> Ported from `.claude/agents/game-designer.md` (Claude Code Game Studios) for OpenCode.
...
> Original skill hints `[design-review, balance-check, brainstorm]` — load via the `skill` tool when relevant.
