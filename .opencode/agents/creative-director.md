...
permission:
  bash: deny
---
> Ported from `.claude/agents/creative-director.md` (Claude Code Game Studios) for OpenCode.
...
> Original skill hints `[brainstorm, design-review]` — load via the `skill` tool when relevant.
