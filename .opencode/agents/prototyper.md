...
permission:
  ...
  websearch: deny
---
> Ported from `.claude/agents/prototyper.md` (Claude Code Game Studios) for OpenCode.
...
> Original `isolation: worktree` has no OpenCode equivalent — use a git worktree/branch manually for throwaway prototypes.
