...
permission:
  ...
  websearch: deny
---
> Ported from `.claude/agents/qa-lead.md` (Claude Code Game Studios) for OpenCode.
...
> Original skill hints `[bug-report, release-checklist]` — load via the `skill` tool when relevant.
